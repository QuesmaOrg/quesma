...
func MapDifference(mActual, mExpected JsonMap, acceptableDifference []string,
	compareBaseTypes, compareFullArrays bool, limitArrayIndices int) (JsonMap, JsonMap) {
...
func MapDifferenceCompareEverything(mActual, mExpected JsonMap) (JsonMap, JsonMap) {
	return MapDifference(mActual, mExpected, []string{}, true, true, math.MaxInt)
}
...
func JsonDifference(jsonActual, jsonExpected string, compareBaseTypes, compareFullArrays bool, limitArrayIndices int) (JsonMap, JsonMap, error) {
	...
	actualMinusExpected, expectedMinusActual := MapDifference(mActual, mExpected, []string{}, false, false, limitArrayIndices)
