...
var KibanaSampleDataFlights = []AggregationTestCase{
	{ // [0]
		...
		ExpectedPancakeSQL: `
			...
			WHERE ("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND "timestamp"<=
			  __quesma_from_unixtime64mili(1740835408853))`,
	},
	{ // [1]
		...
		ExpectedPancakeSQL: `
			...
			FROM __quesma_table_name
			WHERE (("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND "timestamp"<=
			  __quesma_from_unixtime64mili(1740835408853)) AND NOT ("FlightDelayMin" __quesma_match 0))`,
	},
	{ // [2]
		...
		ExpectedPancakeSQL: `
			...
			FROM __quesma_table_name
			WHERE (("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND "timestamp"<=
			  __quesma_from_unixtime64mili(1740835408853)) AND ("FlightDelay" __quesma_match 'true' AND
		...
		ExpectedAdditionalPancakeSQLs: []string{`
				WITH quesma_top_hits_group_table AS (
				  ...
				  FROM __quesma_table_name
				  WHERE (("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND "timestamp"<=
					__quesma_from_unixtime64mili(1740835408853)) AND ("FlightDelay" __quesma_match 'true'
	...
	{ // [5]
		...
		ExpectedPancakeSQL: `
			SELECT countIf(("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND
			  "timestamp"<=__quesma_from_unixtime64mili(1740835408853))) AS
			  "filter_0__aggr__time_offset_split__count",
			  countIf(("timestamp">=__quesma_from_unixtime64mili(1739625808853) AND "timestamp"
			  <=__quesma_from_unixtime64mili(1740230608853))) AS
			  "filter_1__aggr__time_offset_split__count"
			FROM __quesma_table_name
			WHERE ("Cancelled" __quesma_match true AND (("timestamp">=__quesma_from_unixtime64mili(
			  1740230608853) AND "timestamp"<=__quesma_from_unixtime64mili(1740835408853)) OR (
			  "timestamp">=__quesma_from_unixtime64mili(1739625808853) AND "timestamp"<=
			  __quesma_from_unixtime64mili(1740230608853))))`,
	},
	{ // [6]
	...
	{ // [11]
		...
		ExpectedPancakeSQL: `
			...
			FROM __quesma_table_name
			WHERE (("timestamp">=__quesma_from_unixtime64mili(1740230608853) AND "timestamp"<=
			  __quesma_from_unixtime64mili(1740835408853)) AND NOT ("FlightDelayType"
	...
	{ // [12]
		...
		ExpectedPancakeSQL: `
			...
			FROM __quesma_table_name
			WHERE ("OriginLocation" IS NOT NULL AND ("timestamp">=__quesma_from_unixtime64mili(
			  1740230608853) AND "timestamp"<=__quesma_from_unixtime64mili(1740835408853)))
