...
var OpensearchSearchTests = []SearchTestCase{
	{
		...
		WantedSql: []string{
			`("__timestamp">=toDateTime64(1.712236698149e+09,3) AND "__timestamp"<=toDateTime64(1.712237598149e+09,3))`,
		},
		WantedQueryType: model.ListAllFields,
		WantedQueries: []string{
			`SELECT "__bytes", "__timestamp", "message_____"
			FROM __quesma_table_name
			WHERE ("__timestamp">=toDateTime64(1.712236698149e+09, 3) AND "__timestamp"<=toDateTime64(1.712237598149e+09, 3))
