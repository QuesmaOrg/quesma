...
var OpensearchSearchTests = []SearchTestCase{
	{
		...
		WantedSql: []string{
			`("__timestamp">=toDateTime(1712236698149) AND "__timestamp"<=toDateTime(1712237598149))`,
		},
		WantedQueryType: model.ListAllFields,
		WantedQueries: []string{
			`SELECT "__bytes", "__timestamp", "message_____"
			FROM __quesma_table_name
			WHERE ("__timestamp">=toDateTime(1712236698149) AND "__timestamp"<=toDateTime(1712237598149))
