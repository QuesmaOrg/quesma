...
var g = &grammar{
	rules: []*rule{
		...
		{
			name: "OpExpr",
			pos:  position{line: 91, col: 1, offset: 1894},
			expr: &actionExpr{
				pos: position{line: 91, col: 10, offset: 1903},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						&labeledExpr{
							...
							label: "left",
							expr: &ruleRefExpr{
								pos:  position{line: 91, col: 15, offset: 1908},
								name: "Expr",
							},
						},
						&ruleRefExpr{
							pos:  position{line: 91, col: 20, offset: 1913},
							name: "_",
						},
						&labeledExpr{
							pos:   position{line: 91, col: 23, offset: 1916},
							label: "op",
							expr: &ruleRefExpr{
								pos:  position{line: 91, col: 26, offset: 1919},
								name: "Op",
							},
						},
						&ruleRefExpr{
							pos:  position{line: 91, col: 29, offset: 1922},
							name: "_",
						},
						&labeledExpr{
							pos:   position{line: 91, col: 32, offset: 1925},
							label: "right",
							expr: &ruleRefExpr{
								pos:  position{line: 91, col: 38, offset: 1931},
								name: "Expr",
							},
						},
					},
		...
		{
			name: "Op",
			pos:  position{line: 110, col: 1, offset: 2300},
			expr: &actionExpr{
				pos: position{line: 110, col: 6, offset: 2305},
				run: (*parser).callonOp1,
				expr: &labeledExpr{
					pos:   position{line: 110, col: 6, offset: 2305},
					label: "op",
					expr: &litMatcher{
						pos:        position{line: 110, col: 9, offset: 2308},
						val:        "+",
						ignoreCase: false,
						want:       "\"+\"",
					},
		...
		{
			name: "String",
			pos:  position{line: 114, col: 1, offset: 2349},
			expr: &actionExpr{
				pos: position{line: 114, col: 10, offset: 2358},
				...
				expr: &seqExpr{
					...
					exprs: []any{
						...
						&labeledExpr{
							pos:   position{line: 114, col: 15, offset: 2363},
							label: "s",
							expr: &zeroOrMoreExpr{
								pos: position{line: 114, col: 17, offset: 2365},
						...
						&litMatcher{
							pos:        position{line: 114, col: 23, offset: 2371},
							val:        "'",
							ignoreCase: false,
							want:       "\"'\"",
						},
		...
		{
			name: "Identifier",
			pos:  position{line: 121, col: 1, offset: 2494},
			expr: &actionExpr{
				pos: position{line: 121, col: 14, offset: 2507},
				run: (*parser).callonIdentifier1,
				expr: &labeledExpr{
					pos:   position{line: 121, col: 14, offset: 2507},
					label: "id",
					expr: &oneOrMoreExpr{
						pos: position{line: 121, col: 17, offset: 2510},
						expr: &charClassMatcher{
							pos:        position{line: 121, col: 17, offset: 2510},
							val:        "[a-zA-Z0-9_]",
							chars:      []rune{'_'},
		...
		},
		{
			...
			pos:         position{line: 125, col: 1, offset: 2559},
			expr: &zeroOrMoreExpr{
				pos: position{line: 125, col: 19, offset: 2577},
				expr: &charClassMatcher{
					pos:        position{line: 125, col: 19, offset: 2577},
					val:        "[ \\n\\t\\r]",
					chars:      []rune{' ', '\n', '\t', '\r'},
		...
		{
			name: "EOF",
			pos:  position{line: 127, col: 1, offset: 2589},
			expr: &notExpr{
				pos: position{line: 128, col: 5, offset: 2598},
				expr: &anyMatcher{
					line: 128, col: 6, offset: 2599,
				},
			},
			leader:        false,
			leftRecursive: false,
