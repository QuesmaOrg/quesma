...
func Load() QuesmaConfiguration {
	...
	var shadow = viper.Get(fullyQualifiedConfig(shadowModeConfig)).(bool)
	...
	return QuesmaConfiguration{Shadow: shadow, IndexConfig: indexBypass}
}
