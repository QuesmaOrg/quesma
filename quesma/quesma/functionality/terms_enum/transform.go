...
func applyNecessaryTransformations(ctx context.Context, lm clickhouse.LogManagerIFace, tableName string, indexSchema schema.Schema, query *model.Query) (*model.Query, error) {
