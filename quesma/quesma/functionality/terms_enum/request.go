...
// Source: https://github.com/elastic/go-elasticsearch/blob/ab9e8b523888d41d85d475e5440c8634ccf84be7/typedapi/core/termsenum/request.go
...
type Request struct {
	...
	IndexFilter *map[string]interface{} `json:"index_filter,omitempty"`
